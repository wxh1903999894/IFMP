<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DictionaryManage.aspx.cs" Inherits="IFMP.dictionary.DictionaryManage" %>
    ...
    <script>
        $(function () {
            $('#btn_Add').click(function () {
                ...
                return openbox('A_id', 'DictionaryEdit.aspx', '', 900, 350, -1);
            });
        });

        function editinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'DictionaryEdit.aspx', 'id=' + id, 900, 350, 0);
        }
    </script>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span>基础数据管理<span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="字典管理"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
        <div class="listcent searclass">
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="10">
                <tbody>
                    <tr>
                        <td align="right" width="80px">字典名称：
                        </td>
                        <td width="180px">
                            <asp:TextBox runat="server" ID="txt_Name"></asp:TextBox>
                        </td>
                        <td align="right" width="80px">字典类型：</td>
                        <td width="180px">
                    ...
                    <asp:Repeater runat="server" ID="rp_List">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="center"><%#Eval("DisplayType") %></td>
                                <td align="center"><%#Eval("RegexType")==null?"":Eval("RegexType") %></td>
                                <td>

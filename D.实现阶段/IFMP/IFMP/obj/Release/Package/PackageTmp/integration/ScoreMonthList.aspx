<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScoreMonthList.aspx.cs" Inherits="IFMP.integration.ScoreMonthList" %>
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span>积分管理<span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="积分排名"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
 ...
 <%--               <li>
        ...
        <div class="listcent searclass">
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="10">
                <tbody>
                    <tr>
                        <td width="60px" align="right">分组：</td>
                        <td width="120px">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo">
                <tbody>
                    ...
                    <asp:Repeater ID="rp_List" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td><%#GetName(Eval("Number"),Eval("Number"),Eval("isbr")) %></td>
                                <td><%#GetName(Eval("Number"),Eval("RealName"),Eval("isbr"))%></td>
                                <td><%#GetName(Eval("Number"),Eval("Total"),Eval("isbr"))%></td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaveAuditManage.aspx.cs" Inherits="IFMP.sysmanage.LeaveAuditManage" %>
...
<head runat="server">
    ...
    <script>
        function audit(e) {
            ...
            return openbox('A_id', 'LeaveAuditFlow.aspx', 'id=' + id, 1000, 520, 0);
        }
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span>常用操作<span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="请假审核"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="10">
                <tbody>
                    <tr>
                        ...
                        <td width="80px" align="right">开始日期：</td>
                        <td width="240px">
                            ...
                            <tr>
                                <%--<td style="width: 5px;">
                                    <label class="wxz" id='ck_<%#Eval("ID")%>l'>
                                        <input type="checkbox" name="checkbox" onclick="setid(this.id)" value='<%#Eval("ID") %>' id='ck_<%#Eval("ID") %>' <%#Eval("LeaveState").ToString()!="0"?"disabled":"" %> />
                                        /></label>
                                </td>--%>
                                ...
                                <td>
                                    <asp:LinkButton ID="lbtn_Audit" Visible='<%#(Eval("LeaveState").ToString()==IFMPLibrary.Enums.LeaveState.未审核.ToString())?true:false%>' runat="server" CssClass="listbtn btneditcolor" ToolTip="审核" OnClientClick='return audit(this);'>审核</asp:LinkButton>
                                    ...
                                    <asp:HiddenField runat="server" ID="HiddenField1" Value='<%#Eval("LID") %>' />
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
                    <tr runat="server" id="tr_null">
                        <td bgcolor="#ffffff" align="center" colspan="10">暂无记录</td>
                    </tr>
                </tbody>
            </table>
        </div>

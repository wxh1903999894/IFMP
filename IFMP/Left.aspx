        ...
        <ul class="layui-nav layui-nav-tree layui-inline" lay-filter="demo">
            ...
            <li class="layui-nav-item">
                <a href="javascript:;">员工宿舍</a><dl class="layui-nav-child">
                    <dd><a href="dormitory/DormitoryList.aspx" target="main"><span class="iconfont icon-event"></span>宿舍管理</a></dd>
                    <dd><a href="dormitory/SchedulingList.aspx" target="main"><span class="iconfont icon-fl-renshi"></span>点检排班管理</a></dd>
                    <dd><a href="dormitory/DormitoryScoreList.aspx" target="main"><span class="iconfont icon-jiaojieqingkuang"></span>点检问题查询</a></dd>
                    <dd><a href="dormitory/DormitoryScoreMonthList.aspx" target="main"><span class="iconfont icon-xiazai7"></span>宿舍排名</a></dd>
                    <dd><a href="dormitory/ProblemList.aspx" target="main"><span class="iconfont icon-gangweiqiehuan"></span>常见问题管理</a></dd>
                </dl>
            </li>
        </ul>
        <script>

    ...
    public partial class BaseClassList : PageBase
    {
        ...
        public void DataBindList()
        {
            ...
            using (IFMPDBContext db = new IFMPDBContext())
            {
                ...
                List<ProductionLine> ProductionLineList = db.ProductionLine.ToList();
                BaseClassList.ForEach(t => t.ProductionLineName = ProductionLineList.FirstOrDefault(m => m.ID == t.ProductionLineID).Name);

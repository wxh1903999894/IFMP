<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProblemList.aspx.cs" Inherits="IFMP.dormitory.ProblemList" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#btn_Add').click(function () {
                ...
                return openbox('A_id', 'ProblemEdit.aspx', '', 900, 450, -1);
            });
        ...
        function editinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'ProblemEdit.aspx', 'id=' + id, 900, 450, 0);
        }
    </script>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span>员工宿舍<span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="常见问题管理"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
        <div class="listcent searclass">
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="10">
                <tbody>
                    <tr>
                        <td width="60px" align="right">问题：</td>
                        <td width="200px">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo">
                <tbody>
                    <tr>
                        ...
                        <th width="390px"><strong>问题</strong></th>
                        <th width="130px"><strong>顺序</strong></th>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BaseClassList.aspx.cs" Inherits="IFMP.basedata.BaseClassList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#btn_Add').click(function () {
                ...
                return openbox('A_id', 'BaseClassEdit.aspx', '', 680, 260, -1);
            });
        });

        function setuser(e) {
            var id = $(e).next().next().val();
            return openbox('A_id', 'BaseClassUserEdit.html', 'id=' + id, 900, 600, 0);
        }

        function editinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'BaseClassEdit.aspx', 'id=' + id, 680, 260, 0);
        }
    </script>
</head>
<body>
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span>基础数据管理<span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="基础班次设置"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo">
                <tbody>
                    <tr>
                        ...
                        <th><strong>班次名称</strong></th>
                        <th><strong>班次类型</strong></th>
                        <th><strong>生产线</strong></th>
                    ...
                    <asp:Repeater runat="server" ID="rp_List">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <asp:LinkButton ID="lbtn_SetTime" runat="server" CssClass="listbtn btneditcolor" ToolTip="设置人员" OnClientClick="return setuser(this);">设置人员</asp:LinkButton>

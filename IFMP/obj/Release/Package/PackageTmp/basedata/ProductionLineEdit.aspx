<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductionLineEdit.aspx.cs" Inherits="IFMP.basedata.ProductionLineEdit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="listcent pad0">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo">
                <tr>
                    <td align="right">生产线名称：
                    </td>
                    <td>
                        <asp:TextBox ID="txt_Name" datatype="*1-30"  nullmsg="请输入生产线名称"  CssClass="searchbg" runat="server">
                        </asp:TextBox>

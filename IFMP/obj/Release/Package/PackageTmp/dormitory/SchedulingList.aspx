<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchedulingList.aspx.cs" Inherits="IFMP.dormitory.SchedulingList" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#btn_Add').click(function () {
                ...
                return openbox('A_id', 'SchedulingEdit.aspx', '', 600, 450, -1);
            });
        ...
        function editinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'SchedulingEdit.aspx', 'id=' + id, 900, 300, 0);
        }
    </script>
</head>
<body>
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span>员工宿舍<span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="点检排班管理"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo">
                <tbody>
                    <tr>
                        ...
                        <th width="130px"><strong>点检时间</strong></th>
                        <th width="130px"><strong>点检人员</strong></th>

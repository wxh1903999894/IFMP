<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScoreAuditUserManage.aspx.cs" Inherits="IFMP.integration.ScoreAuditUserManage" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#btn_Add').click(function () {
                ...
                return openbox('A_id', 'ScoreAuditUserEdit.aspx', '', 600, 250, -1);
            });
            //$('#btn_Edit').click(function () {
            //    return openbox('A_id', 'UserTypeEdit.aspx', 'tflag=' + $("#hf_tflag").val(), 600, 250, 0)
            //});
        });
        ...
        //function editinfo(e) {
        //    var id = $(e).next().val();
        //    return openbox('A_id', 'ScoreAuditUserEdit.aspx', 'id=' + id, 600, 250, 0);
        //}
    </script>
</head>
<body>
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span>积分管理<span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="审核人员管理"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>

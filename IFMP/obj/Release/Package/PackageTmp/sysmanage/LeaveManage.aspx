<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaveManage.aspx.cs" Inherits="IFMP.sysmanage.LeaveManage" %>
    ...
    <script>
        $(function () {
            $('#btn_Add').click(function () {
                ...
                return openbox('A_id', 'LeaveEdit.aspx', '', 900, 480, -1);
            });
        });

        function editinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'LeaveEdit.aspx', 'id=' + id, 1000, 630, 0);
        }
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span>常用操作<span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="我的请假"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>

            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox runat="server"  datatype="*" nullmsg="请填写手机号码" ID="txt_CellPhone"></asp:TextBox>
                            <span style="color: red;">*</span>
                        </td>
                        <td align="right">身份证号：</td>
                        <td align="left">
                            <asp:TextBox runat="server"  datatype="*" nullmsg="请填写身份证号" ID="txt_Identity"></asp:TextBox>
                            <span style="color: red;">*</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:TextBox runat="server" ID="txt_Address" datatype="*" nullmsg="请填写家庭住址"  TextMode="MultiLine" Width="60%" Height="80px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>

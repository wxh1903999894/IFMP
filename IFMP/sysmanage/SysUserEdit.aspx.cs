                ...
                try
                {
                    using (IFMPDBContext db = new IFMPDBContext())
                    {
                        ...
                        if (user == null)
                        {
                            ...
                            if (string.IsNullOrEmpty(userDetails.Identity))
                            {
                                ShowMessage("请输入身份证号");
                                return;
                            }
                            if (db.UserDetails.FirstOrDefault(t => t.Identity == userDetails.Identity) != null)
                            {
                                ShowMessage("身份证号重复");
                                return;
                            }
                        ...
                        else
                        {
                            ...
                            if (db.User.FirstOrDefault(t => t.ID != user.ID && t.Cellphone == user.Cellphone) != null)
                            {
                                ShowMessage("手机号重复");
                                return;
                            }
                            ...
                            if (string.IsNullOrEmpty(udetail.Identity))
                            {
                                ShowMessage("请输入身份证号");
                                return;
                            }
                            if (db.UserDetails.FirstOrDefault(t => t.Identity == udetail.Identity && t.ID != udetail.ID) != null)
                            {
                                ShowMessage("身份证号重复");
                                return;
                            }
                            ...
                            if (string.IsNullOrEmpty(udetail.Address))
                            {
                                ShowMessage("请输入家庭住址");
                                return;
                            }

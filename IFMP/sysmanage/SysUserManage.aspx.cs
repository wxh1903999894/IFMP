    ...
    public partial class SysUserManage : PageBase
    {
        ...
        private void DataBindList()
        {
            ...
            using (IFMPDBContext db = new IFMPDBContext())
            {
                ...
                List<UserDetails> UserDetailList = db.UserDetails.ToList();
                foreach (User User in Userlist)
                {
                    returnlist.Add(new
                    {
                        ...
                        User.Cellphone,
                        User.UserState,
                        Identity = UserDetailList.FirstOrDefault(t => t.UserID == User.ID).Identity,
                        Address = UserDetailList.FirstOrDefault(t => t.UserID == User.ID).Address,
                    });
                }
